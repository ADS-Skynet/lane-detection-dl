#!/usr/bin/env python3
"""
BiSeNet Lane Detection Inference Script for fine-tune3
Run inference on images or video using trained BiSeNet model
"""
...
class LaneDetectionInference:
    def __init__(self, checkpoint_path, n_classes=2, image_size=(512, 1024), device='cuda'):
        ...
        self.model = create_bisenet_model(n_classes=n_classes, pretrained=False)
